...
For my design, I am going to choose the songs data structure. I feel like this is something that will be
useful in future projects that require the use of APIs specifically taken from spotify. This will help
organize the data in Map.Pair style component (except with a singular key and 2 values), that could potentially
be published for other people to use, via github.
...
https://osu.instructure.com/courses/180707/assignments/4491044
